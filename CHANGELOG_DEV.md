...
- chore(deps): update actions/setup-go action to v7 by @renovate[bot] in https://github.com/michimani/gotwi/pull/360
- chore(deps): update go toolchain directive to v1.26.5 by @renovate[bot] in https://github.com/michimani/gotwi/pull/359
