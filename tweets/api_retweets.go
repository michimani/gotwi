...
func TweetRetweetsRetweetedBy(ctx context.Context, c *gotwi.Client, p *types.TweetRetweetsRetweetedByParams) (*types.TweetRetweetsRetweetedByResponse, error) {
...
func TweetRetweetsPost(ctx context.Context, c *gotwi.Client, p *types.TweetRetweetsPostParams) (*types.TweetRetweetsPostResponse, error) {
...
func TweetRetweetsDelete(ctx context.Context, c *gotwi.Client, p *types.TweetRetweetsDeleteParams) (*types.TweetRetweetsDeleteResponse, error) {
