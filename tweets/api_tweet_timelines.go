...
func TweetTimelinesTweets(ctx context.Context, c *gotwi.Client, p *types.TweetTimelinesTweetsParams) (*types.TweetTimelinesTweetsResponse, error) {
...
func TweetTimelinesMentions(ctx context.Context, c *gotwi.Client, p *types.TweetTimelinesMentionsParams) (*types.TweetTimelinesMentionsResponse, error) {
