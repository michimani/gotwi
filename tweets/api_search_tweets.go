...
func SearchTweetsRecent(c *gotwi.GotwiClient, p *types.SearchTweetsRecentParams) (*types.SearchTweetsRecentResponse, error) {
...
func SearchTweetsAll(c *gotwi.GotwiClient, p *types.SearchTweetsAllParams) (*types.SearchTweetsAllResponse, error) {
