...
func SearchTweetsRecent(ctx context.Context, c *gotwi.Client, p *types.SearchTweetsRecentParams) (*types.SearchTweetsRecentResponse, error) {
...
func SearchTweetsAll(ctx context.Context, c *gotwi.Client, p *types.SearchTweetsAllParams) (*types.SearchTweetsAllResponse, error) {
