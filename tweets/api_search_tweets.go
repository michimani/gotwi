...
func SearchTweetsRecent(c *gotwi.TwitterClient, p *types.SearchTweetsRecentParams) (*types.SearchTweetsRecentResponse, error) {
	res := &types.SearchTweetsRecentResponse{}
	if err := c.CallAPI(SearchTweetsRecentEndpoint, "GET", p, res); err != nil {
		return nil, err
	}
...
func SearchTweetsAll(c *gotwi.TwitterClient, p *types.SearchTweetsAllParams) (*types.SearchTweetsAllResponse, error) {
	res := &types.SearchTweetsAllResponse{}
	if err := c.CallAPI(SearchTweetsAllEndpoint, "GET", p, res); err != nil {
		return nil, err
	}
