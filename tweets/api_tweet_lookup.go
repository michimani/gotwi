...
func TweetLookup(ctx context.Context, c *gotwi.Client, p *types.TweetLookupParams) (*types.TweetLookupResponse, error) {
...
func TweetLookupID(ctx context.Context, c *gotwi.Client, p *types.TweetLookupIDParams) (*types.TweetLookupIDResponse, error) {
