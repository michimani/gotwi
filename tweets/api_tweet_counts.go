...
func TweetCountsRecent(ctx context.Context, c *gotwi.Client, p *types.TweetCountsRecentParams) (*types.TweetCountsRecentResponse, error) {
...
func TweetCountsAll(ctx context.Context, c *gotwi.Client, p *types.TweetCountsAllParams) (*types.TweetCountsAllResponse, error) {
