...
func TweetCountsRecent(c *gotwi.GotwiClient, p *types.TweetCountsRecentParams) (*types.TweetCountsRecentResponse, error) {
...
func TweetCountsAll(c *gotwi.GotwiClient, p *types.TweetCountsAllParams) (*types.TweetCountsAllResponse, error) {
