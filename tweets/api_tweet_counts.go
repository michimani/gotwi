...
func TweetCountsRecent(c *gotwi.TwitterClient, p *types.TweetCountsRecentParams) (*types.TweetCountsRecentResponse, error) {
	res := &types.TweetCountsRecentResponse{}
	if err := c.CallAPI(TweetCountsRecentEndpoint, "GET", p, res); err != nil {
		return nil, err
	}
...
func TweetCountsAll(c *gotwi.TwitterClient, p *types.TweetCountsAllParams) (*types.TweetCountsAllResponse, error) {
	res := &types.TweetCountsAllResponse{}
	if err := c.CallAPI(TweetCountsAllEndpoint, "GET", p, res); err != nil {
		return nil, err
	}
