	...
	cases := []struct {
		...
		},
		{
			...
			expectErrMsg: strings.Join([]string{
				...
				"detail=\"non 2xx error detail\"",
				"type=\"non 2xx error type\"",
				"message_1=\"api-err-1\" errorCode_1=3 errorText_1=\"Invalid coordinates.\" errorDescription_1=\"Corresponds with HTTP 400. The coordinates provided as parameters were not valid for the request.\"",
				"message_2=\"api-err-2\" errorCode_2=13 errorText_2=\"No location associated with the specified IP address.\" errorDescription_2=\"Corresponds with HTTP 404. It was not possible to derive a location for the IP address provided as a parameter on the geo search request.\"",
