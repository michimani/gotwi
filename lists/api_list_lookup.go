...
func ListLookupID(ctx context.Context, c *gotwi.Client, p *types.ListLookupIDParams) (*types.ListLookupIDResponse, error) {
...
func ListLookupOwnedLists(ctx context.Context, c *gotwi.Client, p *types.ListLookupOwnedListsParams) (*types.ListLookupOwnedListsResponse, error) {
