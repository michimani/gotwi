...
func ListMembersListMemberships(ctx context.Context, c *gotwi.Client, p *types.ListMembersListMembershipsParams) (*types.ListMembersListMembershipsResponse, error) {
...
func ListMembersGet(ctx context.Context, c *gotwi.Client, p *types.ListMembersGetParams) (*types.ListMembersGetResponse, error) {
...
func ListMembersPost(ctx context.Context, c *gotwi.Client, p *types.ListMembersPostParams) (*types.ListMembersPostResponse, error) {
...
func ListMembersDelete(ctx context.Context, c *gotwi.Client, p *types.ListMembersDeleteParams) (*types.ListMembersDeleteResponse, error) {
