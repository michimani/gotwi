...
func PinnedListsGet(ctx context.Context, c *gotwi.Client, p *types.PinnedListsGetParams) (*types.PinnedListsGetResponse, error) {
...
func PinnedListsPost(ctx context.Context, c *gotwi.Client, p *types.PinnedListsPostParams) (*types.PinnedListsPostResponse, error) {
...
func PinnedListsDelete(ctx context.Context, c *gotwi.Client, p *types.PinnedListsDeleteParams) (*types.PinnedListsDeleteResponse, error) {
