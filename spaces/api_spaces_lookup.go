...
func SpacesLookupID(ctx context.Context, c *gotwi.Client, p *types.SpacesLookupIDParams) (*types.SpacesLookupIDResponse, error) {
...
func SpacesLookup(ctx context.Context, c *gotwi.Client, p *types.SpacesLookupParams) (*types.SpacesLookupResponse, error) {
...
func SpacesLookupByCreatorIDs(ctx context.Context, c *gotwi.Client, p *types.SpacesLookupByCreatorIDsParams) (*types.SpacesLookupByCreatorIDsResponse, error) {
...
func SpacesLookupBuyers(ctx context.Context, c *gotwi.Client, p *types.SpacesLookupBuyersParams) (*types.SpacesLookupBuyersResponse, error) {
...
func SpacesLookupTweets(ctx context.Context, c *gotwi.Client, p *types.SpacesLookupTweetsParams) (*types.SpacesLookupTweetsResponse, error) {
