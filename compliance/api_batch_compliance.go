...
func BatchComplianceJobs(ctx context.Context, c *gotwi.Client, p *types.BatchComplianceJobsParams) (*types.BatchComplianceJobsResponse, error) {
...
func BatchComplianceJobsID(ctx context.Context, c *gotwi.Client, p *types.BatchComplianceJobsIDParams) (*types.BatchComplianceJobsIDResponse, error) {
...
func BatchComplianceJobsPost(ctx context.Context, c *gotwi.Client, p *types.BatchComplianceJobsPostParams) (*types.BatchComplianceJobsPostResponse, error) {
